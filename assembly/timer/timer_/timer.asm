...
ldi r16, 0b00000100 ;the last 3 bits define the prescaler, 101 => division by 1024
out TCCR0B, r16     ;declearing pin as OUTPUT from ardino .
...
;16 million cycles at 16 MHz = 1 secon
;do not use memory.
